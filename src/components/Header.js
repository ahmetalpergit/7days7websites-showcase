    ...
    return (
        <header className="header">
            ...
            <div className="header__descriptions">
                ...
                <p className="header__description description">I used<a href="https://www.siteinspire.com/" target="_blank" rel="noreferrer">SiteInspire</a>as my inspiration for this one. Below you'll find the links to these websites and their original sources.</p>
            </div>
        </header>
    )
}
